...
export interface ApiFarmingFarming extends Schema.CollectionType {
  collectionName: 'farmings';
  info: {
    singularName: 'farming';
    pluralName: 'farmings';
    displayName: 'farming';
  };
  options: {
  ...
  attributes: {
    key: Attribute.Integer & Attribute.Unique;
    img: Attribute.Text;
    title: Attribute.String;
    raised: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::farming.farming': ApiFarmingFarming;
